...
with open("kanienkeha_vocab_rules.yaml", "r", encoding="utf-8") as f:
...
with open("output/morphemes.json", "w", encoding="utf-8") as f:
    json.dump(morpheme_entries, f, ensure_ascii=False, indent=2)

print(f"✅ Generated {len(morpheme_entries)} conjugations → output/morphemes.json")
